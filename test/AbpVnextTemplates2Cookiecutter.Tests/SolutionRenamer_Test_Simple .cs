...
{
    public  class SolutionRenamer_Test_Simple : SolutionRenamer_Test_Base
    {
        ...
        [Fact]
        public void SolutionRenamer_Run_SimpleCompanyName_SimpleProjectName()
        {
            // Act
            var solutionRename = new SolutionRenamer(TemporaryPath, "MyCompanyName", "MyProjectName", "AkiniCompanyName", "AkiniProjectName");
            solutionRename.Run();
